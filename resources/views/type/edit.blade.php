    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card" style="background-color: white; box-shadow: 0 0 15px 0 red">
                <div style="background: url({{url('assets/images/landorus.png')}}) center center no-repeat; background-size: contain;" class="auth-pokemon"></div>
                <div class="card-header" style="text-align: center; text-transform: uppercase; font-size: 2em; color: black; margin-top: 30px;">Edita el tipo<br>{{$type->name}}</div>
                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ url('pokemontype/' . $type->id) }}">
                        @csrf
                        @method('put')
                        <div class="my-lrinpcon" style="margin-top: 30px">
                            ...
                            style="background-color: #ccc; color: black !important" name="name" value="{{ old('name', $type->name) }}" required autocomplete="off">
                            @error('name')
                        ...
                        <div class="my-lrinpcon" style="margin-top: 30px">
                            ...
                            style="background-color: #ccc; color: black !important" name="color" value="{{ old('color', $type->color) }}" required>
                            @error('color')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
