    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card" style="background-color: white; box-shadow: 0 0 15px 0 red">
                ...
                @endif
                <div class="card-header" style="text-align: center; text-transform: uppercase; font-size: 2em; color: black; margin-top: 30px;">Crea un nuevo<br>Pokémon</div>
                    ...
                    <form method="POST" action="{{ route('pokemon.store') }}" enctype="multipart/form-data">
                        ...
                        <div class="my-lrinpcon" style="margin-top: 30px">
                            ...
                            <select class="form-control" style="background-color: #ccc; color: black !important" id="idprimarytype" name="idprimarytype" required>
                                ...
                                @foreach($types as $type)
                                    <option value="{{ $type->id }}" @if(old('idprimarytype') == $type->id) selected @endif>{{ $type->name }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="my-lrinpcon" style="margin-top: 30px">
                            ...
                            <select class="form-control" style="background-color: #ccc; color: black !important" id="idsecondarytype" name="idsecondarytype">
                                ...
                                @foreach($types as $type)
                                    <option value="{{ $type->id }}" @if(old('idsecondarytype') == $type->id) selected @endif>{{ $type->name }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="my-lrinpcon" style="margin-top: 30px">
                            ...
                            style="background-color: #ccc; color: black !important" name="description" value="{{ old('description') }}" required autocomplete="off">
                            @error('description')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                        ...
                        <div class="my-lrinpcon" style="margin-top: 30px">
                            ...
                            <input id="height" type="number" class="form-control @error('height') is-invalid @enderror" min="0" step="0.1" max="99999999"
                            style="background-color: #ccc; color: black !important" name="height" value="{{ old('height') }}" required autocomplete="off">
                            @error('height')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                        ...
                        <div class="my-lrinpcon" style="margin-top: 30px">
                            ...
                            <input id="weight" type="number" class="form-control @error('weight') is-invalid @enderror" min="0" step="0.1" max="99999999"
                            style="background-color: #ccc; color: black !important" name="weight" value="{{ old('weight') }}" required autocomplete="off">
                            @error('weight')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                        ...
                        <div class="my-lrinpcon" style="margin-top: 30px">
                            ...
                            <div class="parent-div" style="margin-bottom: 25px">
                                <div class="btn-upload" id="btn-upload"></div>
                                <input class="myinputfile" id="myinputfile" style="margin-bottom: 25px" type="file" name="photo" accept="image/*" required />
                            </div>
                        </div>
...
@section('js')
    <script src="{{ url('assets/js/showImg.js') }}" defer></script>
@endsection