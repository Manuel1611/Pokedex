    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card" style="background-color: white; box-shadow: 0 0 15px 0 red">
                <div style="background: url({{url('assets/images/dialga.png')}}) center center no-repeat; background-size: contain;" class="auth-pokemon"></div>
                <div class="card-header" style="text-align: center; text-transform: uppercase; font-size: 2em; color: black; margin-top: 30px;">Crea un nuevo<br>usuario</div>
                ...
                <div class="card-body">
                    ...
                    <form method="POST" id="fuseredit" action="{{ route('user.store') }}">
                        ...
                        <div class="my-lrinpcon" style="margin-top: 30px">
                            ...
                            <input id="password" minlength="8" type="password" class="form-control @error('password') is-invalid @enderror" minlength="8"
                            style="background-color: #ccc; color: black !important" name="password" value="{{ old('password') }}" autocomplete="off" required>
                            @error('password')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                        ...
                        <div class="my-lrinpcon" style="margin-top: 30px; align-items: center">
                            <div class="form-check" style="padding: 0">
                                <input id="verified" type="checkbox" value="true" name="verified" @if(old('verified') != '') checked @endif>
                                <label class="form-check-label" style="color: black" for="verified">
                                    Verificar usuario
                                </label>
                            </div>
                        </div>
